...
import mohammedyouser.com.mustaemalaleppo.Domain.FireStoreTest1;
 ...
 * {@link Ihave_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Ihave_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Ihave_Fragment extends Fragment   implements View.OnClickListener{


    private View fragment_view;
    private Ihave_Fragment.OnFragmentInteractionListener mListener;
    ...
    public Ihave_Fragment() {
        // Required empty public constructor
    }



    public static Ihave_Fragment newInstance(String param1, String param2) {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        populateMyViewHolder(createCustomQuery(getActivity(),PATH_IHAVE,PATH_ITEM_DATE_AND_TIME_REVERSE));
    ...
    public Query createCustomQuery(Activity fragmentActivity, String kind, String searchCriteria) {
        ...
        switch (fragmentActivity.getClass().getName()) {
            ...
            case "mohammedyouser.com.mustaemalaleppo.UI.Ineed_Ihave_Activity_CurrentUser": {
                ...
                /*else
                {
                    Toast.makeText(fragmentActivity, getString(R.string.message_error_empty_items), Toast.LENGTH_SHORT).show();
                }*/
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.fab:
                ...
                /*Intent intent =new Intent(getContext(),FireStoreTest1.class);
                startActivity(intent);*/

                Intent intent =new Intent(getContext(),Add_NewItem_Activity.class);
                intent.putExtra(INTENT_KEY__STATEVALUE, INTENT_VALUE__STATEVALUE_IHAVE);
