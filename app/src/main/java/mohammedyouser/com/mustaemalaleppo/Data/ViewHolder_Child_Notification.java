...
public class ViewHolder_Child_Notification extends ChildViewHolder {
    ...
    public ViewHolder_Child_Notification(View itemView_child) {
        ...
        m_imgView_userImage = itemView_child.findViewById(R.id.img_notification_user);
